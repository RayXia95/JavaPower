...
public class IceCream implements Comparable<IceCream> {
	...
	// The natural order of IceCream is: Something in the object thats unique
	// flavor
	@Override
	public int compareTo(IceCream o) {
		return this.flavor.compareTo(o.flavor); // Ascending
		//return o.flavor.compareTo(this.flavor); // Descending
	}
